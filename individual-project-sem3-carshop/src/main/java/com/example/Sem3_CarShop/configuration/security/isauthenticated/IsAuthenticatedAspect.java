package com.example.Sem3_CarShop.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.example.Sem3_CarShop.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.example.Sem3_CarShop.configuration.security.isauthenticated.IsAuthenticated)")
